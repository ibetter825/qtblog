...
;(function ($, window, undefined)
{
    ...
    */
        ...
        if (this.options.navigation !== 0)
        {
            ...
            if (this.rowCount !== -1 && paginationItems.length > 0)
            {
                ...
                renderPaginationItem.call(this, pagination, "last", "&raquo;", "last")
                    ._bgEnableAria(totalPages > current);
                /*--修改--*/
                var paginationContainer = $('<div class="pagination"></div>').append(pagination);
                replacePlaceHolder.call(this, paginationItems, paginationContainer);
            }
        }
    }
    ...
    Grid.defaults = {
        ...
        rowCount: [10, 25, 50, 100, 500],//[10, 25, 50, -1], // rows per page int or array of int (-1 represents "All")
        ...
        css: {
            ...
            sortable: "sortable",
            table: "bootgrid-table table table-striped table-bordered"
        },
        ...
        templates: {
            ...
            actionDropDown: "<div class=\"{{css.dropDownMenu}}\"><button class=\"btn btn-default dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\"><span class=\"{{css.dropDownMenuText}}\">{{ctx.content}}</span> <span class=\"caret\"></span></button><ul style=\"left:0;\" class=\"{{css.dropDownMenuItems}}\" role=\"menu\"></ul></div>",
            actionDropDownItem: "<li><a data-action=\"{{ctx.action}}\" class=\"{{css.dropDownItem}} {{css.dropDownItemButton}}\">{{ctx.text}}</a></li>",
            actionDropDownCheckboxItem: "<li><label class=\"{{css.dropDownItem}}\"><input name=\"{{ctx.name}}\" type=\"checkbox\" value=\"1\" class=\"{{css.dropDownItemCheckbox}}\" {{ctx.checked}} /> {{ctx.label}}</label></li>",
            actions: "<div class=\"{{css.actions}}\"></div>",
            body: "<tbody></tbody>",
            cell: "<td class=\"{{ctx.css}}\" style=\"{{ctx.style}}\">{{ctx.content}}</td>",
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row-fluid\"><div class=\"span6 \"><div style=\"float:left;\" class=\"actionBar\"><p class=\"{{css.actions}}\"></p></div><div class=\"infoBar\" style=\"float:left;\"><p class=\"{{css.infos}}\"></p></div></div><div class=\"span6\"><p class=\"{{css.pagination}}\"></p></div></div></div>",
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"></div>",
            headerCell: "<th data-column-id=\"{{ctx.column.id}}\" class=\"{{ctx.css}}\" style=\"{{ctx.style}}\"><a href=\"javascript:void(0);\" class=\"{{css.columnHeaderAnchor}} {{ctx.sortable}}\"><span class=\"{{css.columnHeaderText}}\">{{ctx.column.text}}</span>{{ctx.icon}}</a></th>",
            icon: "<span class=\"{{css.icon}} {{ctx.iconCss}}\"></span>",
            infos: "<div class=\"{{css.infos}} btn\">{{lbl.infos}}</div>",
            loading: "<tr><td colspan=\"{{ctx.columns}}\" class=\"loading\">{{lbl.loading}}</td></tr>",
            noResults: "<tr><td colspan=\"{{ctx.columns}}\" class=\"no-results\">{{lbl.noResults}}</td></tr>",
            pagination: "<ul style=\"float:right;\"></ul>",

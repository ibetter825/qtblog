...
import com.mypro.common.tools.ToolSecurityIDEA;
import com.mypro.common.tools.ToolString;
...
*/	}
	 ...
	 * @return
	 */
	public static SysUser getCurrentUser(HttpServletRequest request, boolean userAgentVali) {
	 ...
	 * @param autoLogin
	 */
	public static void setCurrentUser(HttpServletRequest request, HttpServletResponse response, SysUser user, boolean autoLogin) {
		// 1.设置cookie有效时间
		int maxAgeTemp = -1;
		if (autoLogin) {
		...
		// 3.生成登陆认证cookie
		String userIds = user.getStr("USER_NO");//user.getPKValue();

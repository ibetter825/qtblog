...
public class MyCaptchaRender extends Render {
    ...
    private static String randomCodeKey = "QTBLOG_JLHHWH_KEY";
    ...
    public void render() {
        ...
        vCode = encrypt(vCode);
        //将验证码存在Cookie中，
        ToolWeb.addCookie(response, null, null, true, randomCodeKey, vCode, 0);
    ...
    public static boolean validate(Controller controller, String inputRandomCode) {
        ...
        try {
            ...
            boolean res = inputRandomCode.equals(controller.getCookie(randomCodeKey));
            if(res)
            	ToolWeb.addCookie(controller, null, null, true, randomCodeKey, null, 0);
            return res;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
